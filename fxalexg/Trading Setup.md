...
- Stop at one given point, and then have a movement to the upside. 
- Day trader predict when the stop is going to stop to have the entry to have the push to the upside
- Anticipate when the stop is by the area of interest 
- Point when the market has respected minimum of 3 times (touches)

![](attachments/Pasted%20image%2020250611161945.png)

![](attachments/Pasted%20image%2020250611162618.png)
...
- Daily
- 4 H
Enter the trade based on direction of higher time frame:
- 2H 
- 1 H
- 30m
- 15m
